...
//TO add concurrency to this gotta only do
  ...
  go foo()
  go bar()
//But now nothing Happens because there are three Go routines running here
//Main, foo, bar. Once main gets over everything terminates, it dosen't let foo & bar get over
